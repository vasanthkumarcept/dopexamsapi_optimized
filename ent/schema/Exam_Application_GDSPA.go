...
func (Exam_Applications_GDSPA) Fields() []ent.Field {
	return []ent.Field{
...
func (Exam_Applications_GDSPA) Indexes() []ent.Index {
	return []ent.Index{
...
func (Exam_Applications_GDSPA) Edges() []ent.Edge {
	return []ent.Edge{
		...
		edge.To("UsersGDSPARef", UserMaster.Type),
		//edge.To("ExamAppln_GDSPA_Ref", Exam_PA.Type),
		//edge.From("offices", Facility.Type).Ref("Office_IP_Ref").Unique().Field("FacilityID"),
		//edge.To("Office_GDSPA_Ref", Facility.Type),
		edge.From("examcitycenter", ExamCityCenter.Type).Ref("ExamCityCenterGDSPARef").Unique().Field("ExamCityCenterCode"),
		edge.From("GDSPAExamCentres", Center.Type). Ref("ExamCentresRefGDSPA").Unique().Field("CenterCode"),
		edge.From("roleusers", RoleMaster.Type).Ref("Roles_GDSPA_Ref").Unique().Field("RoleUserCode"),
		edge.To("CadrePref_Ref", Cadre_Choice_PA.Type),
		edge.To("CirclePrefRefGDSPA", Division_Choice_PA.Type),
		edge.To("GDSPAApplicationsRef", RecommendationsGDSPAApplications.Type),
		//edge.From("GDSPAExamCentres", Center.Type). Ref("ExamCentresRefGDSPA").Unique().Field("ExamCityCenterCode"),
		edge.From("Exams", Exam.Type).Ref("ExamMasterRefGDSPA").Unique().Field("ExamCode"),
	//edge.From("EmpCategoryRef", EmployeeCategory.Type).Ref("ExpCatRefsGDSPA").Unique().Field("CategoryCode"),
		edge.From("CircleRefsGDSPA", CircleSummaryForNO.Type).Ref("CircleRefsForHallTicketGDSPA").Unique().Field("CircleSID"),
		edge.To("LogData", Logs.Type),
	//	edge.From("ExamCenterHallGDSPARefs", ExamCenterHall.Type).Ref("ExamCenterHallGDSPARef").Unique().Field("ExamCenterHall"),
...
func (Exam_Applications_GDSPA) Annotations() []schema.Annotation {
	return []schema.Annotation{entsql.Annotation{Table: "Exam_Applications_GDSPA"}}
}
