...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			adminmaster.Table:                        adminmaster.ValidColumn,
			ageeligibility.Table:                     ageeligibility.ValidColumn,
			application.Table:                        application.ValidColumn,
			cadreeligibleconfiguration.Table:         cadreeligibleconfiguration.ValidColumn,
			cadre_choice_ip.Table:                    cadre_choice_ip.ValidColumn,
			cadre_choice_mtspmmg.Table:               cadre_choice_mtspmmg.ValidColumn,
			cadre_choice_pa.Table:                    cadre_choice_pa.ValidColumn,
			cadre_choice_pm.Table:                    cadre_choice_pm.ValidColumn,
			cadre_choice_pmpa.Table:                  cadre_choice_pmpa.ValidColumn,
			cadre_choice_ps.Table:                    cadre_choice_ps.ValidColumn,
			categorymininummarkmapping.Table:         categorymininummarkmapping.ValidColumn,
			center.Table:                             center.ValidColumn,
			circlesummaryforno.Table:                 circlesummaryforno.ValidColumn,
			directorateusers.Table:                   directorateusers.ValidColumn,
			disability.Table:                         disability.ValidColumn,
			division_choice_mtspmmg.Table:            division_choice_mtspmmg.ValidColumn,
			division_choice_pa.Table:                 division_choice_pa.ValidColumn,
			division_choice_pm.Table:                 division_choice_pm.ValidColumn,
			division_choice_pmpa.Table:               division_choice_pmpa.ValidColumn,
			educationdetails.Table:                   educationdetails.ValidColumn,
			eligibilitycadrepaymatrix.Table:          eligibilitycadrepaymatrix.ValidColumn,
			...
			employeegroup.Table:                      employeegroup.ValidColumn,
			...
			errorlogs.Table:                          errorlogs.ValidColumn,
			exam.Table:                               exam.ValidColumn,
			examcalendar.Table:                       examcalendar.ValidColumn,
			examcategorydisabilitymapping.Table:      examcategorydisabilitymapping.ValidColumn,
			examcenterhall.Table:                     examcenterhall.ValidColumn,
			examcitycenter.Table:                     examcitycenter.ValidColumn,
			examnotifications.Table:                  examnotifications.ValidColumn,
			exampapers.Table:                         exampapers.ValidColumn,
			exampostmapping.Table:                    exampostmapping.ValidColumn,
			examtype.Table:                           examtype.ValidColumn,
			exam_application_mtspmmg.Table:           exam_application_mtspmmg.ValidColumn,
			exam_applications_gdspa.Table:            exam_applications_gdspa.ValidColumn,
			exam_applications_gdspm.Table:            exam_applications_gdspm.ValidColumn,
			exam_applications_ip.Table:               exam_applications_ip.ValidColumn,
			exam_applications_pmpa.Table:             exam_applications_pmpa.ValidColumn,
			exam_applications_ps.Table:               exam_applications_ps.ValidColumn,
			facilitymasters.Table:                    facilitymasters.ValidColumn,
			...
			placeofpreferenceps.Table:                placeofpreferenceps.ValidColumn,
			postexampaper.Table:                      postexampaper.ValidColumn,
			recommendationsgdspaapplications.Table:   recommendationsgdspaapplications.ValidColumn,
			recommendationsgdspmapplications.Table:   recommendationsgdspmapplications.ValidColumn,
			recommendationsipapplications.Table:      recommendationsipapplications.ValidColumn,
			recommendationsmtspmmgapplications.Table: recommendationsmtspmmgapplications.ValidColumn,
			recommendationspmpaapplications.Table:    recommendationspmpaapplications.ValidColumn,
			recommendationspsapplications.Table:      recommendationspsapplications.ValidColumn,
			...
			smsemaillog.Table:                        smsemaillog.ValidColumn,
