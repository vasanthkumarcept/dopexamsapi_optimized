...
const (
	...
	// FieldPostPrefValue holds the string denoting the postprefvalue field in the database.
	FieldPostPrefValue = "post_pref_value"
	...
	ApplnGDSPMRefTable = "Cadre_Choice_PM"
...
// ByPostPrefValue orders the results by the PostPrefValue field.
func ByPostPrefValue(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPostPrefValue, opts...).ToFunc()
}
