...
func (RecommendationsPMPAApplications) Fields() []ent.Field {
	return []ent.Field{
...
func (RecommendationsPMPAApplications) Edges() []ent.Edge {
	return []ent.Edge{
		edge.From("ApplnRef", Exam_Applications_PMPA.Type).Ref("PMPAApplicationsRef").Unique(),
		//.Field("ApplicationID"),
		}
...
func (RecommendationsPMPAApplications) Annotations() []schema.Annotation {
	return []schema.Annotation{entsql.Annotation{Table: "RecommendationsPMPAApplications"}}
}
