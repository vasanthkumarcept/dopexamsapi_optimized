...
type Exam_Applications_PSEdges struct {
	...
	// CadrePrefPSRef holds the value of the CadrePrefPS_Ref edge.
	CadrePrefPSRef []*Cadre_Choice_PS `json:"CadrePrefPS_Ref,omitempty"`
	// CirclePrefRefPS holds the value of the CirclePrefRefPS edge.
	CirclePrefRefPS []*PlaceOfPreferencePS `json:"CirclePrefRefPS,omitempty"`
	// PSApplicationsRef holds the value of the PSApplicationsRef edge.
	PSApplicationsRef []*RecommendationsPSApplications `json:"PSApplicationsRef,omitempty"`
	// ExamsPS holds the value of the ExamsPS edge.
	ExamsPS *Exam `json:"ExamsPS,omitempty"`
	...
	// PSExamCentres holds the value of the PSExamCentres edge.
	PSExamCentres *Center `json:"PSExamCentres,omitempty"`
...
// CadrePrefPSRefOrErr returns the CadrePrefPSRef value or an error if the edge
// was not loaded in eager-loading.
func (e Exam_Applications_PSEdges) CadrePrefPSRefOrErr() ([]*Cadre_Choice_PS, error) {
	if e.loadedTypes[1] {
		return e.CadrePrefPSRef, nil
	}
	return nil, &NotLoadedError{edge: "CadrePrefPS_Ref"}
}

// CirclePrefRefPSOrErr returns the CirclePrefRefPS value or an error if the edge
// was not loaded in eager-loading.
func (e Exam_Applications_PSEdges) CirclePrefRefPSOrErr() ([]*PlaceOfPreferencePS, error) {
	if e.loadedTypes[2] {
		return e.CirclePrefRefPS, nil
	}
	return nil, &NotLoadedError{edge: "CirclePrefRefPS"}
}

// PSApplicationsRefOrErr returns the PSApplicationsRef value or an error if the edge
// was not loaded in eager-loading.
func (e Exam_Applications_PSEdges) PSApplicationsRefOrErr() ([]*RecommendationsPSApplications, error) {
	if e.loadedTypes[3] {
		return e.PSApplicationsRef, nil
	}
	return nil, &NotLoadedError{edge: "PSApplicationsRef"}
}

// ExamsPSOrErr returns the ExamsPS value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e Exam_Applications_PSEdges) ExamsPSOrErr() (*Exam, error) {
	if e.loadedTypes[4] {
		if e.ExamsPS == nil {
			// Edge was loaded but was not found.
			return nil, &NotFoundError{label: exam.Label}
		}
		return e.ExamsPS, nil
	}
	return nil, &NotLoadedError{edge: "ExamsPS"}
}
...
// was not loaded in eager-loading, or loaded but was not found.
func (e Exam_Applications_PSEdges) ExamcitycenterOrErr() (*ExamCityCenter, error) {
	if e.loadedTypes[6] {
...
// PSExamCentresOrErr returns the PSExamCentres value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e Exam_Applications_PSEdges) PSExamCentresOrErr() (*Center, error) {
	if e.loadedTypes[7] {
		if e.PSExamCentres == nil {
			// Edge was loaded but was not found.
			return nil, &NotFoundError{label: center.Label}
		}
		return e.PSExamCentres, nil
	}
	return nil, &NotLoadedError{edge: "PSExamCentres"}
}

// CircleRefsOrErr returns the CircleRefs value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e Exam_Applications_PSEdges) CircleRefsOrErr() (*CircleSummaryForNO, error) {
	if e.loadedTypes[8] {
		if e.CircleRefs == nil {
			// Edge was loaded but was not found.
...
// was not loaded in eager-loading.
func (e Exam_Applications_PSEdges) LogDataOrErr() ([]*Logs, error) {
	if e.loadedTypes[9] {
...
func (*Exam_Applications_PS) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case exam_applications_ps.FieldID, exam_applications_ps.FieldExamCode, exam_applications_ps.FieldUserID, exam_applications_ps.FieldEmployeeID, exam_applications_ps.FieldDisabilityPercentage, exam_applications_ps.FieldWorkingOfficePincode, exam_applications_ps.FieldExamCityCenterCode, exam_applications_ps.FieldVAUserId, exam_applications_ps.FieldCAUserId, exam_applications_ps.FieldNAUserId, exam_applications_ps.FieldRoleUserCode, exam_applications_ps.FieldCircleSID, exam_applications_ps.FieldCenterId, exam_applications_ps.FieldCenterCode, exam_applications_ps.FieldExamCenterHall:
			values[i] = new(sql.NullInt64)
		case exam_applications_ps.FieldApplicationNumber, exam_applications_ps.FieldExamShortName, exam_applications_ps.FieldExamName, exam_applications_ps.FieldSmsExamShortName, exam_applications_ps.FieldExamYear, exam_applications_ps.FieldEmployeeName, exam_applications_ps.FieldDOB, exam_applications_ps.FieldGender, exam_applications_ps.FieldMobileNumber, exam_applications_ps.FieldEmailID, exam_applications_ps.FieldCategoryCode, exam_applications_ps.FieldCategoryDescription, exam_applications_ps.FieldDisabilityTypeID, exam_applications_ps.FieldDisabilityTypeCode, exam_applications_ps.FieldDisabilityTypeDescription, exam_applications_ps.FieldDCCS, exam_applications_ps.FieldEntryPostCode, exam_applications_ps.FieldEntryPostDescription, exam_applications_ps.FieldPresentPostCode, exam_applications_ps.FieldPresentPostDescription, exam_applications_ps.FieldFeederPostCode, exam_applications_ps.FieldFeederPostDescription, exam_applications_ps.FieldFeederPostJoiningDate, exam_applications_ps.FieldDesignationID, exam_applications_ps.FieldPresentDesignation, exam_applications_ps.FieldEducationCode, exam_applications_ps.FieldEducationDescription, exam_applications_ps.FieldFacilityUniqueID, exam_applications_ps.FieldWorkingOfficeFacilityID, exam_applications_ps.FieldWorkingOfficeName, exam_applications_ps.FieldWorkingOfficeCircleFacilityID, exam_applications_ps.FieldWorkingOfficeCircleName, exam_applications_ps.FieldWorkingOfficeRegionFacilityID, exam_applications_ps.FieldWorkingOfficeRegionName, exam_applications_ps.FieldWorkingOfficeDivisionFacilityID, exam_applications_ps.FieldWorkingOfficeDivisionName, exam_applications_ps.FieldReportingOfficeFacilityID, exam_applications_ps.FieldReportingOfficeName, exam_applications_ps.FieldLienControllingOfficeID, exam_applications_ps.FieldLienControllingOfficeName, exam_applications_ps.FieldInDeputation, exam_applications_ps.FieldDeputationType, exam_applications_ps.FieldDeputationOfficeUniqueId, exam_applications_ps.FieldDeputationOfficeFacilityID, exam_applications_ps.FieldDeputationOfficeName, exam_applications_ps.FieldDeputationControllingOfficeID, exam_applications_ps.FieldDeputationControllingOfficeName, exam_applications_ps.FieldControllingOfficeFacilityID, exam_applications_ps.FieldControllingOfficeName, exam_applications_ps.FieldNodalOfficeFacilityID, exam_applications_ps.FieldNodalOfficeName, exam_applications_ps.FieldCenterFacilityId, exam_applications_ps.FieldCentrePreference, exam_applications_ps.FieldSignature, exam_applications_ps.FieldPhoto, exam_applications_ps.FieldSignaturePath, exam_applications_ps.FieldPhotoPath, exam_applications_ps.FieldTempHallTicket, exam_applications_ps.FieldCandidateRemarks, exam_applications_ps.FieldVAGeneralRemarks, exam_applications_ps.FieldCAGeneralRemarks, exam_applications_ps.FieldNAGeneralRemarks, exam_applications_ps.FieldApplicationStatus, exam_applications_ps.FieldStatus, exam_applications_ps.FieldVAUserName, exam_applications_ps.FieldVAEmployeeID, exam_applications_ps.FieldVAEmployeeDesignation, exam_applications_ps.FieldVARemarks, exam_applications_ps.FieldCAUserName, exam_applications_ps.FieldCAEmployeeID, exam_applications_ps.FieldCAEmployeeDesignation, exam_applications_ps.FieldCARemarks, exam_applications_ps.FieldNAUserName, exam_applications_ps.FieldNAEmployeeID, exam_applications_ps.FieldNAEmployeeDesignation, exam_applications_ps.FieldNARemarks, exam_applications_ps.FieldAppliactionRemarks, exam_applications_ps.FieldCAPreviousRemarks, exam_applications_ps.FieldHallTicketNumber, exam_applications_ps.FieldTemporaryHallTicket, exam_applications_ps.FieldOptionUsed, exam_applications_ps.FieldRemarks, exam_applications_ps.FieldCadre, exam_applications_ps.FieldEmployeePost, exam_applications_ps.FieldDOJInEligiblePost, exam_applications_ps.FieldFacilityName, exam_applications_ps.FieldDCInPresentCadre, exam_applications_ps.FieldClaimingQualifyingService, exam_applications_ps.FieldDeputationOfficePincode, exam_applications_ps.FieldRecommendedStatus, exam_applications_ps.FieldUpdatedBy, exam_applications_ps.FieldHallName, exam_applications_ps.FieldReportingOfficeID:
			values[i] = new(sql.NullString)
		case exam_applications_ps.FieldApplnSubmittedDate, exam_applications_ps.FieldVADate, exam_applications_ps.FieldCADate, exam_applications_ps.FieldNADate, exam_applications_ps.FieldHallTicketGeneratedDate, exam_applications_ps.FieldUpdatedAt, exam_applications_ps.FieldApplicationWdlDate:
			values[i] = new(sql.NullTime)
		case exam_applications_ps.ForeignKeys[0]: // employee_master_emp_ref
			values[i] = new(sql.NullInt64)
		case exam_applications_ps.ForeignKeys[1]: // user_master_users_ps_ref
			values[i] = new(sql.NullInt64)
		default:
...
func (eap *Exam_Applications_PS) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case exam_applications_ps.FieldSmsExamShortName:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_ps.FieldUserID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
		...
		case exam_applications_ps.FieldWorkingOfficeDivisionName:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_ps.FieldReportingOfficeFacilityID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_ps.FieldDeputationControllingOfficeName:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_ps.FieldControllingOfficeFacilityID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_ps.FieldStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field Status", values[i])
			} else if value.Valid {
				eap.Status = value.String
			}
		case exam_applications_ps.FieldVAUserId:
			if value, ok := values[i].(*sql.NullInt64); !ok {
		...
		case exam_applications_ps.FieldCAUserId:
			if value, ok := values[i].(*sql.NullInt64); !ok {
		...
		case exam_applications_ps.FieldNAUserId:
			if value, ok := values[i].(*sql.NullInt64); !ok {
		...
		case exam_applications_ps.FieldDOJInEligiblePost:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_ps.FieldCircleSID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
		...
		case exam_applications_ps.FieldNonQualifyingService:
			if value, ok := values[i].(*[]byte); !ok {
...
// QueryCadrePrefPSRef queries the "CadrePrefPS_Ref" edge of the Exam_Applications_PS entity.
func (eap *Exam_Applications_PS) QueryCadrePrefPSRef() *CadreChoicePSQuery {
	return NewExamApplicationsPSClient(eap.config).QueryCadrePrefPSRef(eap)
}

// QueryCirclePrefRefPS queries the "CirclePrefRefPS" edge of the Exam_Applications_PS entity.
func (eap *Exam_Applications_PS) QueryCirclePrefRefPS() *PlaceOfPreferencePSQuery {
	return NewExamApplicationsPSClient(eap.config).QueryCirclePrefRefPS(eap)
}

// QueryPSApplicationsRef queries the "PSApplicationsRef" edge of the Exam_Applications_PS entity.
func (eap *Exam_Applications_PS) QueryPSApplicationsRef() *RecommendationsPSApplicationsQuery {
	return NewExamApplicationsPSClient(eap.config).QueryPSApplicationsRef(eap)
}

// QueryExamsPS queries the "ExamsPS" edge of the Exam_Applications_PS entity.
func (eap *Exam_Applications_PS) QueryExamsPS() *ExamQuery {
	return NewExamApplicationsPSClient(eap.config).QueryExamsPS(eap)
}
...
// QueryExamcitycenter queries the "examcitycenter" edge of the Exam_Applications_PS entity.
func (eap *Exam_Applications_PS) QueryExamcitycenter() *ExamCityCenterQuery {
	return NewExamApplicationsPSClient(eap.config).QueryExamcitycenter(eap)
}

// QueryPSExamCentres queries the "PSExamCentres" edge of the Exam_Applications_PS entity.
func (eap *Exam_Applications_PS) QueryPSExamCentres() *CenterQuery {
	return NewExamApplicationsPSClient(eap.config).QueryPSExamCentres(eap)
}

// QueryCircleRefs queries the "CircleRefs" edge of the Exam_Applications_PS entity.
func (eap *Exam_Applications_PS) QueryCircleRefs() *CircleSummaryForNOQuery {
	return NewExamApplicationsPSClient(eap.config).QueryCircleRefs(eap)
}

// QueryLogData queries the "LogData" edge of the Exam_Applications_PS entity.
func (eap *Exam_Applications_PS) QueryLogData() *LogsQuery {
	return NewExamApplicationsPSClient(eap.config).QueryLogData(eap)
}
