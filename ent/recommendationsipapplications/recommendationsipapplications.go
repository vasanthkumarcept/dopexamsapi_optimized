...
const (
	...
	ApplnRefColumn = "exam_applications_ip_ip_applications_ref"
)
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "RecommendationsIPApplications"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"exam_applications_ip_ip_applications_ref",
}
