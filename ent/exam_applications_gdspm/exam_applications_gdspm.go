...
const (
	// Label holds the string label denoting the exam_applications_gdspm type in the database.
	Label = "exam_applications_gdspm"
	...
	// FieldGDSEngagement holds the string denoting the gdsengagement field in the database.
	FieldGDSEngagement = "gds_engagement"
	// FieldPMMailGuardMTSEngagement holds the string denoting the pmmailguardmtsengagement field in the database.
	FieldPMMailGuardMTSEngagement = "pm_mail_guard_mts_engagement"
	// EdgeUsersGDSPMRef holds the string denoting the usersgdspmref edge name in mutations.
	EdgeUsersGDSPMRef = "UsersGDSPMRef"
	// EdgeCadrePrefRefGDSPM holds the string denoting the cadreprefrefgdspm edge name in mutations.
	EdgeCadrePrefRefGDSPM = "CadrePrefRefGDSPM"
	// EdgeCirclePrefRefGDSPM holds the string denoting the circleprefrefgdspm edge name in mutations.
	EdgeCirclePrefRefGDSPM = "CirclePrefRefGDSPM"
	// EdgeGDSPMApplicationsRef holds the string denoting the gdspmapplicationsref edge name in mutations.
	EdgeGDSPMApplicationsRef = "GDSPMApplicationsRef"
	...
	EdgeExams = "Exams"
	// EdgeGDSPMExamCentres holds the string denoting the gdspmexamcentres edge name in mutations.
	EdgeGDSPMExamCentres = "GDSPMExamCentres"
	// EdgeCircleRefsGDSPM holds the string denoting the circlerefsgdspm edge name in mutations.
	EdgeCircleRefsGDSPM = "CircleRefsGDSPM"
	...
	// Cadre_Choice_PMFieldID holds the string denoting the ID field of the Cadre_Choice_PM.
	Cadre_Choice_PMFieldID = "CadrePrefId"
	// Division_Choice_PMFieldID holds the string denoting the ID field of the Division_Choice_PM.
	Division_Choice_PMFieldID = "CadrePrefId"
	// RecommendationsGDSPMApplicationsFieldID holds the string denoting the ID field of the RecommendationsGDSPMApplications.
	RecommendationsGDSPMApplicationsFieldID = "RecommendationId"
	...
	// Table holds the table name of the exam_applications_gdspm in the database.
	Table = "Exam_Applications_GDSPM"
	// UsersGDSPMRefTable is the table that holds the UsersGDSPMRef relation/edge.
	UsersGDSPMRefTable = "UserMaster"
	// UsersGDSPMRefInverseTable is the table name for the UserMaster entity.
	// It exists in this package in order to avoid circular dependency with the "usermaster" package.
	UsersGDSPMRefInverseTable = "UserMaster"
	// UsersGDSPMRefColumn is the table column denoting the UsersGDSPMRef relation/edge.
	UsersGDSPMRefColumn = "exam_applications_gdspm_users_gdspm_ref"
	// CadrePrefRefGDSPMTable is the table that holds the CadrePrefRefGDSPM relation/edge.
	CadrePrefRefGDSPMTable = "Cadre_Choice_PM"
	// CadrePrefRefGDSPMInverseTable is the table name for the Cadre_Choice_PM entity.
	// It exists in this package in order to avoid circular dependency with the "cadre_choice_pm" package.
	CadrePrefRefGDSPMInverseTable = "Cadre_Choice_PM"
	// CadrePrefRefGDSPMColumn is the table column denoting the CadrePrefRefGDSPM relation/edge.
	CadrePrefRefGDSPMColumn = "application_id"
	// CirclePrefRefGDSPMTable is the table that holds the CirclePrefRefGDSPM relation/edge.
	CirclePrefRefGDSPMTable = "Division_Choice_PM"
	// CirclePrefRefGDSPMInverseTable is the table name for the Division_Choice_PM entity.
	// It exists in this package in order to avoid circular dependency with the "division_choice_pm" package.
	CirclePrefRefGDSPMInverseTable = "Division_Choice_PM"
	// CirclePrefRefGDSPMColumn is the table column denoting the CirclePrefRefGDSPM relation/edge.
	CirclePrefRefGDSPMColumn = "application_id"
	// GDSPMApplicationsRefTable is the table that holds the GDSPMApplicationsRef relation/edge.
	GDSPMApplicationsRefTable = "RecommendationsGDSPMApplications"
	// GDSPMApplicationsRefInverseTable is the table name for the RecommendationsGDSPMApplications entity.
	// It exists in this package in order to avoid circular dependency with the "recommendationsgdspmapplications" package.
	GDSPMApplicationsRefInverseTable = "RecommendationsGDSPMApplications"
	// GDSPMApplicationsRefColumn is the table column denoting the GDSPMApplicationsRef relation/edge.
	GDSPMApplicationsRefColumn = "exam_applications_gdspm_gdspm_applications_ref"
	...
	LogDataColumn = "exam_applications_gdspm_log_data"
	// ExamsTable is the table that holds the Exams relation/edge.
	ExamsTable = "Exam_Applications_GDSPM"
	...
	// GDSPMExamCentresTable is the table that holds the GDSPMExamCentres relation/edge.
	GDSPMExamCentresTable = "Exam_Applications_GDSPM"
	// GDSPMExamCentresInverseTable is the table name for the Center entity.
	// It exists in this package in order to avoid circular dependency with the "center" package.
	GDSPMExamCentresInverseTable = "Center"
	// GDSPMExamCentresColumn is the table column denoting the GDSPMExamCentres relation/edge.
	GDSPMExamCentresColumn = "center_code"
	// CircleRefsGDSPMTable is the table that holds the CircleRefsGDSPM relation/edge.
	CircleRefsGDSPMTable = "Exam_Applications_GDSPM"
	// CircleRefsGDSPMInverseTable is the table name for the CircleSummaryForNO entity.
	// It exists in this package in order to avoid circular dependency with the "circlesummaryforno" package.
	CircleRefsGDSPMInverseTable = "CircleSummaryForNO"
	// CircleRefsGDSPMColumn is the table column denoting the CircleRefsGDSPM relation/edge.
	CircleRefsGDSPMColumn = "circle_sid"
	// RoleusersTable is the table that holds the roleusers relation/edge.
	RoleusersTable = "Exam_Applications_GDSPM"
	...
	ExamcitycenterTable = "Exam_Applications_GDSPM"
...
// Columns holds all SQL columns for exam_applications_gdspm fields.
var Columns = []string{
	FieldID,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "Exam_Applications_GDSPM"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"user_master_users_gdspm_ref",
}
...
// OrderOption defines the ordering options for the Exam_Applications_GDSPM queries.
...
// ByCadrePrefRefGDSPMCount orders the results by CadrePrefRefGDSPM count.
func ByCadrePrefRefGDSPMCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newCadrePrefRefGDSPMStep(), opts...)
	}
}

// ByCadrePrefRefGDSPM orders the results by CadrePrefRefGDSPM terms.
func ByCadrePrefRefGDSPM(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newCadrePrefRefGDSPMStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}

// ByCirclePrefRefGDSPMCount orders the results by CirclePrefRefGDSPM count.
func ByCirclePrefRefGDSPMCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newCirclePrefRefGDSPMStep(), opts...)
	}
}

// ByCirclePrefRefGDSPM orders the results by CirclePrefRefGDSPM terms.
func ByCirclePrefRefGDSPM(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newCirclePrefRefGDSPMStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}

// ByGDSPMApplicationsRefCount orders the results by GDSPMApplicationsRef count.
func ByGDSPMApplicationsRefCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newGDSPMApplicationsRefStep(), opts...)
	}
}

// ByGDSPMApplicationsRef orders the results by GDSPMApplicationsRef terms.
func ByGDSPMApplicationsRef(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newGDSPMApplicationsRefStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
// ByGDSPMExamCentresField orders the results by GDSPMExamCentres field.
func ByGDSPMExamCentresField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newGDSPMExamCentresStep(), sql.OrderByField(field, opts...))
	}
}

// ByCircleRefsGDSPMField orders the results by CircleRefsGDSPM field.
func ByCircleRefsGDSPMField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newCircleRefsGDSPMStep(), sql.OrderByField(field, opts...))
	}
}
...
func newUsersGDSPMRefStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		...
		sqlgraph.To(UsersGDSPMRefInverseTable, UserMasterFieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, UsersGDSPMRefTable, UsersGDSPMRefColumn),
	)
}
func newCadrePrefRefGDSPMStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(CadrePrefRefGDSPMInverseTable, Cadre_Choice_PMFieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, CadrePrefRefGDSPMTable, CadrePrefRefGDSPMColumn),
	)
}
func newCirclePrefRefGDSPMStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(CirclePrefRefGDSPMInverseTable, Division_Choice_PMFieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, CirclePrefRefGDSPMTable, CirclePrefRefGDSPMColumn),
	)
}
func newGDSPMApplicationsRefStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(GDSPMApplicationsRefInverseTable, RecommendationsGDSPMApplicationsFieldID),
...
func newGDSPMExamCentresStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(GDSPMExamCentresInverseTable, CenterFieldID),
		sqlgraph.Edge(sqlgraph.M2O, true, GDSPMExamCentresTable, GDSPMExamCentresColumn),
	)
}
func newCircleRefsGDSPMStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(CircleRefsGDSPMInverseTable, CircleSummaryForNOFieldID),
