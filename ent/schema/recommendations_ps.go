...
func (RecommendationsPSApplications) Fields() []ent.Field {
	return []ent.Field{
...
func (RecommendationsPSApplications) Edges() []ent.Edge {
	return []ent.Edge{
		edge.From("ApplnRefPS", Exam_Applications_PS.Type).Ref("PSApplicationsRef").Unique(),
		//.Field("ApplicationID"),
		}
...
func (RecommendationsPSApplications) Annotations() []schema.Annotation {
	return []schema.Annotation{entsql.Annotation{Table: "RecommendationsPSApplications"}}
}
