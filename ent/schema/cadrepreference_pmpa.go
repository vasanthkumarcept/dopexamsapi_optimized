...
/// Fields of the Exam.
func (Cadre_Choice_PMPA) Fields() []ent.Field {
...
// Edges of the Exam.
func (Cadre_Choice_PMPA) Edges() []ent.Edge {
	 return []ent.Edge{edge.From("ApplnPMPA_Ref", Exam_Applications_PMPA.Type).Ref("CadrePref_Ref").Unique().Field("ApplicationID"),
}
	//[]ent.Edge{		
...
func (Cadre_Choice_PMPA) Annotations() []schema.Annotation {
	return []schema.Annotation{entsql.Annotation{Table: "Cadre_Choice_PMPA"}}
}
