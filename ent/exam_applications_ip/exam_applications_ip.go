...
const (
	...
	// FieldCACorrected holds the string denoting the cacorrected field in the database.
	FieldCACorrected = "ca_corrected"
	// FieldCACorrectedDate holds the string denoting the cacorrecteddate field in the database.
	FieldCACorrectedDate = "ca_corrected_date"
	...
	EdgeLogData = "LogData"
	// EdgeExamCentres holds the string denoting the examcentres edge name in mutations.
	EdgeExamCentres = "ExamCentres"
	...
	CirclePrefRefColumn = "exam_applications_ip_circle_pref_ref"
	...
	IPApplicationsRefColumn = "exam_applications_ip_ip_applications_ref"
	...
	LogDataColumn = "exam_applications_ip_log_data"
	// ExamCentresTable is the table that holds the ExamCentres relation/edge.
	ExamCentresTable = "Exam_Applications_IP"
	// ExamCentresInverseTable is the table name for the Center entity.
	// It exists in this package in order to avoid circular dependency with the "center" package.
	ExamCentresInverseTable = "Center"
	// ExamCentresColumn is the table column denoting the ExamCentres relation/edge.
	ExamCentresColumn = "center_code"
	// ExamcitycenterTable is the table that holds the examcitycenter relation/edge.
	ExamcitycenterTable = "Exam_Applications_IP"
	...
	CircleRefsTable = "Exam_Applications_IP"
...
// ByCACorrected orders the results by the CACorrected field.
func ByCACorrected(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldCACorrected, opts...).ToFunc()
}

// ByCACorrectedDate orders the results by the CACorrectedDate field.
func ByCACorrectedDate(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldCACorrectedDate, opts...).ToFunc()
}
...
// ByExamCentresField orders the results by ExamCentres field.
func ByExamCentresField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newExamCentresStep(), sql.OrderByField(field, opts...))
	}
}
...
func newExamCentresStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(ExamCentresInverseTable, CenterFieldID),
