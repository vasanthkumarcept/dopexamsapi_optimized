...
const (
	// Label holds the string label denoting the exam_application_mtspmmg type in the database.
	Label = "exam_application_mtspmmg"
	...
	// EdgeUsersMTSPMMGRef holds the string denoting the usersmtspmmgref edge name in mutations.
	EdgeUsersMTSPMMGRef = "UsersMTSPMMGRef"
	...
	// EdgeCirclePrefRefMTSPMMG holds the string denoting the circleprefrefmtspmmg edge name in mutations.
	EdgeCirclePrefRefMTSPMMG = "CirclePrefRefMTSPMMG"
	// EdgeMTSPMMGApplicationsRef holds the string denoting the mtspmmgapplicationsref edge name in mutations.
	EdgeMTSPMMGApplicationsRef = "MTSPMMGApplicationsRef"
	// EdgeMTSPMMGExamCentres holds the string denoting the mtspmmgexamcentres edge name in mutations.
	EdgeMTSPMMGExamCentres = "MTSPMMGExamCentres"
	...
	EdgeExams = "Exams"
	// EdgeCircleRefsMTSPMMG holds the string denoting the circlerefsmtspmmg edge name in mutations.
	EdgeCircleRefsMTSPMMG = "CircleRefsMTSPMMG"
	...
	// Cadre_Choice_MTSPMMGFieldID holds the string denoting the ID field of the Cadre_Choice_MTSPMMG.
	Cadre_Choice_MTSPMMGFieldID = "CadrePrefId"
	// Division_Choice_MTSPMMGFieldID holds the string denoting the ID field of the Division_Choice_MTSPMMG.
	Division_Choice_MTSPMMGFieldID = "CadrePrefId"
	// RecommendationsMTSPMMGApplicationsFieldID holds the string denoting the ID field of the RecommendationsMTSPMMGApplications.
	RecommendationsMTSPMMGApplicationsFieldID = "RecommendationId"
	...
	LogsFieldID = "ID"
	// Table holds the table name of the exam_application_mtspmmg in the database.
	Table = "Exam_Application_MTSPMMG"
	// UsersMTSPMMGRefTable is the table that holds the UsersMTSPMMGRef relation/edge.
	UsersMTSPMMGRefTable = "UserMaster"
	// UsersMTSPMMGRefInverseTable is the table name for the UserMaster entity.
	// It exists in this package in order to avoid circular dependency with the "usermaster" package.
	UsersMTSPMMGRefInverseTable = "UserMaster"
	// UsersMTSPMMGRefColumn is the table column denoting the UsersMTSPMMGRef relation/edge.
	UsersMTSPMMGRefColumn = "exam_application_mtspmmg_users_mtspmmg_ref"
	// RoleusersTable is the table that holds the roleusers relation/edge.
	RoleusersTable = "Exam_Application_MTSPMMG"
	...
	CadrePrefRefTable = "Cadre_Choice_MTSPMMG"
	// CadrePrefRefInverseTable is the table name for the Cadre_Choice_MTSPMMG entity.
	// It exists in this package in order to avoid circular dependency with the "cadre_choice_mtspmmg" package.
	CadrePrefRefInverseTable = "Cadre_Choice_MTSPMMG"
	// CadrePrefRefColumn is the table column denoting the CadrePref_Ref relation/edge.
	CadrePrefRefColumn = "application_id"
	// CirclePrefRefMTSPMMGTable is the table that holds the CirclePrefRefMTSPMMG relation/edge.
	CirclePrefRefMTSPMMGTable = "Division_Choice_MTSPMMG"
	// CirclePrefRefMTSPMMGInverseTable is the table name for the Division_Choice_MTSPMMG entity.
	// It exists in this package in order to avoid circular dependency with the "division_choice_mtspmmg" package.
	CirclePrefRefMTSPMMGInverseTable = "Division_Choice_MTSPMMG"
	// CirclePrefRefMTSPMMGColumn is the table column denoting the CirclePrefRefMTSPMMG relation/edge.
	CirclePrefRefMTSPMMGColumn = "application_id"
	// MTSPMMGApplicationsRefTable is the table that holds the MTSPMMGApplicationsRef relation/edge.
	MTSPMMGApplicationsRefTable = "RecommendationsMTSPMMGApplications"
	// MTSPMMGApplicationsRefInverseTable is the table name for the RecommendationsMTSPMMGApplications entity.
	// It exists in this package in order to avoid circular dependency with the "recommendationsmtspmmgapplications" package.
	MTSPMMGApplicationsRefInverseTable = "RecommendationsMTSPMMGApplications"
	// MTSPMMGApplicationsRefColumn is the table column denoting the MTSPMMGApplicationsRef relation/edge.
	MTSPMMGApplicationsRefColumn = "application_id"
	// MTSPMMGExamCentresTable is the table that holds the MTSPMMGExamCentres relation/edge.
	MTSPMMGExamCentresTable = "Exam_Application_MTSPMMG"
	// MTSPMMGExamCentresInverseTable is the table name for the Center entity.
	// It exists in this package in order to avoid circular dependency with the "center" package.
	MTSPMMGExamCentresInverseTable = "Center"
	// MTSPMMGExamCentresColumn is the table column denoting the MTSPMMGExamCentres relation/edge.
	MTSPMMGExamCentresColumn = "center_code"
	// ExamcitycenterTable is the table that holds the examcitycenter relation/edge.
	ExamcitycenterTable = "Exam_Application_MTSPMMG"
	...
	ExamsTable = "Exam_Application_MTSPMMG"
	...
	// CircleRefsMTSPMMGTable is the table that holds the CircleRefsMTSPMMG relation/edge.
	CircleRefsMTSPMMGTable = "Exam_Application_MTSPMMG"
	// CircleRefsMTSPMMGInverseTable is the table name for the CircleSummaryForNO entity.
	// It exists in this package in order to avoid circular dependency with the "circlesummaryforno" package.
	CircleRefsMTSPMMGInverseTable = "CircleSummaryForNO"
	// CircleRefsMTSPMMGColumn is the table column denoting the CircleRefsMTSPMMG relation/edge.
	CircleRefsMTSPMMGColumn = "circle_sid"
	...
	LogDataColumn = "exam_application_mtspmmg_log_data"
)

// Columns holds all SQL columns for exam_application_mtspmmg fields.
var Columns = []string{
	FieldID,
...
// OrderOption defines the ordering options for the Exam_Application_MTSPMMG queries.
...
// ByUsersMTSPMMGRefCount orders the results by UsersMTSPMMGRef count.
func ByUsersMTSPMMGRefCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newUsersMTSPMMGRefStep(), opts...)
	}
}

// ByUsersMTSPMMGRef orders the results by UsersMTSPMMGRef terms.
func ByUsersMTSPMMGRef(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newUsersMTSPMMGRefStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
// ByCirclePrefRefMTSPMMGCount orders the results by CirclePrefRefMTSPMMG count.
func ByCirclePrefRefMTSPMMGCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newCirclePrefRefMTSPMMGStep(), opts...)
	}
}

// ByCirclePrefRefMTSPMMG orders the results by CirclePrefRefMTSPMMG terms.
func ByCirclePrefRefMTSPMMG(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newCirclePrefRefMTSPMMGStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}

// ByMTSPMMGApplicationsRefCount orders the results by MTSPMMGApplicationsRef count.
func ByMTSPMMGApplicationsRefCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newMTSPMMGApplicationsRefStep(), opts...)
	}
}

// ByMTSPMMGApplicationsRef orders the results by MTSPMMGApplicationsRef terms.
func ByMTSPMMGApplicationsRef(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newMTSPMMGApplicationsRefStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}

// ByMTSPMMGExamCentresField orders the results by MTSPMMGExamCentres field.
func ByMTSPMMGExamCentresField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newMTSPMMGExamCentresStep(), sql.OrderByField(field, opts...))
	}
}
...
// ByCircleRefsMTSPMMGField orders the results by CircleRefsMTSPMMG field.
func ByCircleRefsMTSPMMGField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newCircleRefsMTSPMMGStep(), sql.OrderByField(field, opts...))
	}
}
...
func newUsersMTSPMMGRefStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(UsersMTSPMMGRefInverseTable, UserMasterFieldID),
...
func newCadrePrefRefStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(CadrePrefRefInverseTable, Cadre_Choice_MTSPMMGFieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, CadrePrefRefTable, CadrePrefRefColumn),
	)
}
func newCirclePrefRefMTSPMMGStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(CirclePrefRefMTSPMMGInverseTable, Division_Choice_MTSPMMGFieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, CirclePrefRefMTSPMMGTable, CirclePrefRefMTSPMMGColumn),
	)
}
func newMTSPMMGApplicationsRefStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(MTSPMMGApplicationsRefInverseTable, RecommendationsMTSPMMGApplicationsFieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, MTSPMMGApplicationsRefTable, MTSPMMGApplicationsRefColumn),
	)
}
func newMTSPMMGExamCentresStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(MTSPMMGExamCentresInverseTable, CenterFieldID),
...
func newCircleRefsMTSPMMGStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(CircleRefsMTSPMMGInverseTable, CircleSummaryForNOFieldID),
