		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{ExamApplicationsPMPAColumns[127]},
				RefColumns: []*schema.Column{CenterColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "Exam_Applications_PMPA_CircleSummaryForNO_CircleRefsForHallTicketPMPA",
				Columns:    []*schema.Column{ExamApplicationsPMPAColumns[128]},
				RefColumns: []*schema.Column{CircleSummaryForNOColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationsPMPAColumns[8], ExamApplicationsPMPAColumns[6], ExamApplicationsPMPAColumns[69]},
			},
			{
				Name:    "exam_applications_pmpa_application_number_exam_year_status",
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationsPMPAColumns[1], ExamApplicationsPMPAColumns[6], ExamApplicationsPMPAColumns[69]},
			},
			{
				Name:    "exam_applications_pmpa_controlling_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationsPMPAColumns[53], ExamApplicationsPMPAColumns[6], ExamApplicationsPMPAColumns[69]},
			},
			{
				Name:    "exam_applications_pmpa_nodal_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationsPMPAColumns[55], ExamApplicationsPMPAColumns[6], ExamApplicationsPMPAColumns[69]},
			},
		},
	}
