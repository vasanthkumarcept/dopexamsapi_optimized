...
const (
	// Label holds the string label denoting the recommendationspmpaapplications type in the database.
	Label = "recommendations_pmpa_applications"
	...
	// Table holds the table name of the recommendationspmpaapplications in the database.
	Table = "RecommendationsPMPAApplications"
	// ApplnRefTable is the table that holds the ApplnRef relation/edge.
	ApplnRefTable = "RecommendationsPMPAApplications"
	// ApplnRefInverseTable is the table name for the Exam_Applications_PMPA entity.
	// It exists in this package in order to avoid circular dependency with the "exam_applications_pmpa" package.
	ApplnRefInverseTable = "Exam_Applications_PMPA"
	// ApplnRefColumn is the table column denoting the ApplnRef relation/edge.
	ApplnRefColumn = "exam_applications_pmpa_pmpa_applications_ref"
)

// Columns holds all SQL columns for recommendationspmpaapplications fields.
var Columns = []string{
	FieldID,
	FieldApplicationID,
	FieldEmployeeID,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "RecommendationsPMPAApplications"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"exam_applications_pmpa_pmpa_applications_ref",
}
...
// OrderOption defines the ordering options for the RecommendationsPMPAApplications queries.
...
func newApplnRefStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		...
		sqlgraph.To(ApplnRefInverseTable, Exam_Applications_PMPAFieldID),
