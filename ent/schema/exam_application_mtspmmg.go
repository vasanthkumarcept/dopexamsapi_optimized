...
// Exam_Application_MTSPMMG holds the schema definition for the Exam_Application_MTSPMMG entity.
type Exam_Application_MTSPMMG struct {
	ent.Schema
}

// Fields of the Exam_Application_MTSPMMG.
func (Exam_Application_MTSPMMG) Fields() []ent.Field {
	return []ent.Field{
...
func (Exam_Application_MTSPMMG) Indexes() []ent.Index {
	return []ent.Index{
...
// Edges of the Exam_Application_MTSPMMG.
func (Exam_Application_MTSPMMG) Edges() []ent.Edge {
	return []ent.Edge{
		...
		edge.To("UsersMTSPMMGRef", UserMaster.Type),
		//	edge.To("ExamAppln_MTSPMMG_Ref", Exam_MTSPMMG.Type),
		//edge.From("offices", Facility.Type).Ref("Office_IP_Ref").Unique().Field("FacilityID"),
		//edge.To("Office_MTSPMMG_Ref", Facility.Type),

		edge.From("roleusers", RoleMaster.Type).Ref("Roles_MTSPMMG_Ref").Unique().Field("RoleUserCode"),
		edge.To("CadrePref_Ref", Cadre_Choice_MTSPMMG.Type),
		edge.To("CirclePrefRefMTSPMMG", Division_Choice_MTSPMMG.Type),
		edge.To("MTSPMMGApplicationsRef", RecommendationsMTSPMMGApplications.Type),
		edge.From("MTSPMMGExamCentres", Center.Type).Ref("ExamCentresRefMTSPMMG").Unique().Field("CenterCode"),
		edge.From("examcitycenter", ExamCityCenter.Type).Ref("ExamCityCenterMTSPMMGRef").Unique().Field("ExamCityCenterCode"),
		//edge.From("MTSPMMGExamCentres", Center.Type).Ref("ExamCentresRefMTSPMMG").Unique().Field("ExamCityCenterCode"),
		edge.From("Exams", Exam.Type).Ref("ExamMasterRefMTSPMMG").Unique().Field("ExamCode"),
		//edge.From("EmpCategoryRef", EmployeeCategory.Type).Ref("ExpCatRefsMTSPMMG").Unique().Field("CategoryCode"),
		edge.From("CircleRefsMTSPMMG", CircleSummaryForNO.Type).Ref("CircleRefsForHallTicketMTSPMMG").Unique().Field("CircleSID"),
		edge.To("LogData", Logs.Type),
	//	edge.From("ExamCenterHallMTSPMMGRefs", ExamCenterHall.Type).Ref("ExamCenterHallMTSPMMGRef").Unique().Field("ExamCenterHall"),
	}
}

func (Exam_Application_MTSPMMG) Annotations() []schema.Annotation {
	return []schema.Annotation{entsql.Annotation{Table: "Exam_Application_MTSPMMG"}}
}
