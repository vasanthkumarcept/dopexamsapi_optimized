	...
	ExamApplicationMTSPMMGTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{ExamApplicationMTSPMMGColumns[127]},
				RefColumns: []*schema.Column{ExamCityCenterColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "Exam_Application_MTSPMMG_RoleMaster_Roles_MTSPMMG_Ref",
				Columns:    []*schema.Column{ExamApplicationMTSPMMGColumns[128]},
				RefColumns: []*schema.Column{RoleMasterColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationMTSPMMGColumns[8], ExamApplicationMTSPMMGColumns[6], ExamApplicationMTSPMMGColumns[71]},
			},
			{
				Name:    "exam_application_mtspmmg_application_number_exam_year_status",
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationMTSPMMGColumns[1], ExamApplicationMTSPMMGColumns[6], ExamApplicationMTSPMMGColumns[71]},
			},
			{
				Name:    "exam_application_mtspmmg_controlling_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationMTSPMMGColumns[53], ExamApplicationMTSPMMGColumns[6], ExamApplicationMTSPMMGColumns[71]},
			},
			{
				Name:    "exam_application_mtspmmg_nodal_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationMTSPMMGColumns[55], ExamApplicationMTSPMMGColumns[6], ExamApplicationMTSPMMGColumns[71]},
			},
		},
	}
	...
	ExamApplicationsGDSPATable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{ExamApplicationsGDSPAColumns[129]},
				RefColumns: []*schema.Column{RoleMasterColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "Exam_Applications_GDSPA_UserMaster_UsersGDSPARef",
				Columns:    []*schema.Column{ExamApplicationsGDSPAColumns[130]},
				RefColumns: []*schema.Column{UserMasterColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationsGDSPAColumns[8], ExamApplicationsGDSPAColumns[6], ExamApplicationsGDSPAColumns[72]},
			},
			{
				Name:    "exam_applications_gdspa_application_number_exam_year_status",
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationsGDSPAColumns[1], ExamApplicationsGDSPAColumns[6], ExamApplicationsGDSPAColumns[72]},
			},
			{
				Name:    "exam_applications_gdspa_controlling_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationsGDSPAColumns[52], ExamApplicationsGDSPAColumns[6], ExamApplicationsGDSPAColumns[72]},
			},
			{
				Name:    "exam_applications_gdspa_nodal_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationsGDSPAColumns[56], ExamApplicationsGDSPAColumns[6], ExamApplicationsGDSPAColumns[72]},
			},
		},
	}
	...
	ExamApplicationsGDSPMTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{ExamApplicationsGDSPMColumns[131]},
				RefColumns: []*schema.Column{RoleMasterColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "Exam_Applications_GDSPM_UserMaster_UsersGDSPMRef",
				Columns:    []*schema.Column{ExamApplicationsGDSPMColumns[132]},
				RefColumns: []*schema.Column{UserMasterColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationsGDSPMColumns[8], ExamApplicationsGDSPMColumns[6], ExamApplicationsGDSPMColumns[73]},
			},
			{
				Name:    "exam_applications_gdspm_application_number_exam_year_status",
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationsGDSPMColumns[1], ExamApplicationsGDSPMColumns[6], ExamApplicationsGDSPMColumns[73]},
			},
			{
				Name:    "exam_applications_gdspm_controlling_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationsGDSPMColumns[53], ExamApplicationsGDSPMColumns[6], ExamApplicationsGDSPMColumns[73]},
			},
			{
				Name:    "exam_applications_gdspm_nodal_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationsGDSPMColumns[55], ExamApplicationsGDSPMColumns[6], ExamApplicationsGDSPMColumns[73]},
			},
		},
	}
	...
	ExamApplicationsIPTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{ExamApplicationsIPColumns[129]},
				RefColumns: []*schema.Column{RoleMasterColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "Exam_Applications_IP_UserMaster_UsersIPRef",
				Columns:    []*schema.Column{ExamApplicationsIPColumns[130]},
				RefColumns: []*schema.Column{UserMasterColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationsIPColumns[9], ExamApplicationsIPColumns[7], ExamApplicationsIPColumns[72]},
			},
			{
				Name:    "exam_applications_ip_application_number_exam_year_status",
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationsIPColumns[1], ExamApplicationsIPColumns[7], ExamApplicationsIPColumns[72]},
			},
			{
				Name:    "exam_applications_ip_controlling_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationsIPColumns[54], ExamApplicationsIPColumns[7], ExamApplicationsIPColumns[72]},
			},
			{
				Name:    "exam_applications_ip_nodal_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationsIPColumns[56], ExamApplicationsIPColumns[7], ExamApplicationsIPColumns[72]},
			},
		},
	}
	...
	ExamApplicationsPMPATable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{ExamApplicationsPMPAColumns[135]},
				RefColumns: []*schema.Column{UserMasterColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	ExamApplicationsPSTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{ExamApplicationsPSColumns[126]},
				RefColumns: []*schema.Column{RoleMasterColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "Exam_Applications_PS_UserMaster_UsersPSRef",
				Columns:    []*schema.Column{ExamApplicationsPSColumns[127]},
				RefColumns: []*schema.Column{UserMasterColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationsPSColumns[8], ExamApplicationsPSColumns[6], ExamApplicationsPSColumns[71]},
			},
			{
				Name:    "exam_applications_ps_application_number_exam_year_status",
				Unique:  true,
				Columns: []*schema.Column{ExamApplicationsPSColumns[1], ExamApplicationsPSColumns[6], ExamApplicationsPSColumns[71]},
			},
			{
				Name:    "exam_applications_ps_controlling_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationsPSColumns[53], ExamApplicationsPSColumns[6], ExamApplicationsPSColumns[71]},
			},
			{
				Name:    "exam_applications_ps_nodal_office_facility_id_exam_year_status",
				Unique:  false,
				Columns: []*schema.Column{ExamApplicationsPSColumns[55], ExamApplicationsPSColumns[6], ExamApplicationsPSColumns[71]},
			},
		},
	}
