...
const (
	// Label holds the string label denoting the employeegroup type in the database.
	...
	// Table holds the table name of the employeegroup in the database.
	Table = "EmployeeGroup"
)

// Columns holds all SQL columns for employeegroup fields.
var Columns = []string{
	FieldID,
	FieldGroupCode,
...
// OrderOption defines the ordering options for the EmployeeGroup queries.
...
// ByGroupCode orders the results by the GroupCode field.
