...
// Exam_Applications_GDSPA is the model entity for the Exam_Applications_GDSPA schema.
type Exam_Applications_GDSPA struct {
	config `json:"-"`
	// ID of the ent.
	...
	// The values are being populated by the Exam_Applications_GDSPAQuery when eager-loading is set.
	Edges                       Exam_Applications_GDSPAEdges `json:"edges"`
	user_master_users_gdspa_ref *int64
	selectValues                sql.SelectValues
}

// Exam_Applications_GDSPAEdges holds the relations/edges for other nodes in the graph.
type Exam_Applications_GDSPAEdges struct {
	// UsersGDSPARef holds the value of the UsersGDSPARef edge.
	UsersGDSPARef []*UserMaster `json:"UsersGDSPARef,omitempty"`
	// Examcitycenter holds the value of the examcitycenter edge.
	Examcitycenter *ExamCityCenter `json:"examcitycenter,omitempty"`
	// GDSPAExamCentres holds the value of the GDSPAExamCentres edge.
	GDSPAExamCentres *Center `json:"GDSPAExamCentres,omitempty"`
	...
	CadrePrefRef []*Cadre_Choice_PA `json:"CadrePref_Ref,omitempty"`
	// CirclePrefRefGDSPA holds the value of the CirclePrefRefGDSPA edge.
	CirclePrefRefGDSPA []*Division_Choice_PA `json:"CirclePrefRefGDSPA,omitempty"`
	// GDSPAApplicationsRef holds the value of the GDSPAApplicationsRef edge.
	GDSPAApplicationsRef []*RecommendationsGDSPAApplications `json:"GDSPAApplicationsRef,omitempty"`
	// Exams holds the value of the Exams edge.
	Exams *Exam `json:"Exams,omitempty"`
	// CircleRefsGDSPA holds the value of the CircleRefsGDSPA edge.
	CircleRefsGDSPA *CircleSummaryForNO `json:"CircleRefsGDSPA,omitempty"`
...
func (e Exam_Applications_GDSPAEdges) UsersGDSPARefOrErr() ([]*UserMaster, error) {
	if e.loadedTypes[0] {
...
func (e Exam_Applications_GDSPAEdges) ExamcitycenterOrErr() (*ExamCityCenter, error) {
	if e.loadedTypes[1] {
...
// GDSPAExamCentresOrErr returns the GDSPAExamCentres value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e Exam_Applications_GDSPAEdges) GDSPAExamCentresOrErr() (*Center, error) {
	if e.loadedTypes[2] {
		if e.GDSPAExamCentres == nil {
			// Edge was loaded but was not found.
			return nil, &NotFoundError{label: center.Label}
		}
		return e.GDSPAExamCentres, nil
	}
	return nil, &NotLoadedError{edge: "GDSPAExamCentres"}
}

// RoleusersOrErr returns the Roleusers value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e Exam_Applications_GDSPAEdges) RoleusersOrErr() (*RoleMaster, error) {
	if e.loadedTypes[3] {
		if e.Roleusers == nil {
			// Edge was loaded but was not found.
...
// was not loaded in eager-loading.
func (e Exam_Applications_GDSPAEdges) CadrePrefRefOrErr() ([]*Cadre_Choice_PA, error) {
	if e.loadedTypes[4] {
...
// CirclePrefRefGDSPAOrErr returns the CirclePrefRefGDSPA value or an error if the edge
// was not loaded in eager-loading.
func (e Exam_Applications_GDSPAEdges) CirclePrefRefGDSPAOrErr() ([]*Division_Choice_PA, error) {
	if e.loadedTypes[5] {
		return e.CirclePrefRefGDSPA, nil
	}
	return nil, &NotLoadedError{edge: "CirclePrefRefGDSPA"}
}

// GDSPAApplicationsRefOrErr returns the GDSPAApplicationsRef value or an error if the edge
// was not loaded in eager-loading.
func (e Exam_Applications_GDSPAEdges) GDSPAApplicationsRefOrErr() ([]*RecommendationsGDSPAApplications, error) {
	if e.loadedTypes[6] {
		return e.GDSPAApplicationsRef, nil
	}
	return nil, &NotLoadedError{edge: "GDSPAApplicationsRef"}
}

// ExamsOrErr returns the Exams value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e Exam_Applications_GDSPAEdges) ExamsOrErr() (*Exam, error) {
	if e.loadedTypes[7] {
		if e.Exams == nil {
			// Edge was loaded but was not found.
...
// CircleRefsGDSPAOrErr returns the CircleRefsGDSPA value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e Exam_Applications_GDSPAEdges) CircleRefsGDSPAOrErr() (*CircleSummaryForNO, error) {
	if e.loadedTypes[8] {
		if e.CircleRefsGDSPA == nil {
			// Edge was loaded but was not found.
			return nil, &NotFoundError{label: circlesummaryforno.Label}
		}
		return e.CircleRefsGDSPA, nil
	}
	return nil, &NotLoadedError{edge: "CircleRefsGDSPA"}
}

// LogDataOrErr returns the LogData value or an error if the edge
// was not loaded in eager-loading.
func (e Exam_Applications_GDSPAEdges) LogDataOrErr() ([]*Logs, error) {
	if e.loadedTypes[9] {
...
func (*Exam_Applications_GDSPA) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case exam_applications_gdspa.FieldID, exam_applications_gdspa.FieldExamCode, exam_applications_gdspa.FieldUserID, exam_applications_gdspa.FieldEmployeeID, exam_applications_gdspa.FieldDisabilityPercentage, exam_applications_gdspa.FieldWorkingOfficePincode, exam_applications_gdspa.FieldExamCityCenterCode, exam_applications_gdspa.FieldVAUserId, exam_applications_gdspa.FieldCAUserId, exam_applications_gdspa.FieldNAUserId, exam_applications_gdspa.FieldRoleUserCode, exam_applications_gdspa.FieldCircleSID, exam_applications_gdspa.FieldCenterId, exam_applications_gdspa.FieldCenterCode, exam_applications_gdspa.FieldExamCenterHall:
			values[i] = new(sql.NullInt64)
		case exam_applications_gdspa.FieldApplicationNumber, exam_applications_gdspa.FieldExamShortName, exam_applications_gdspa.FieldExamName, exam_applications_gdspa.FieldSmsExamShortName, exam_applications_gdspa.FieldExamYear, exam_applications_gdspa.FieldEmployeeName, exam_applications_gdspa.FieldDOB, exam_applications_gdspa.FieldGender, exam_applications_gdspa.FieldMobileNumber, exam_applications_gdspa.FieldEmailID, exam_applications_gdspa.FieldCategoryCode, exam_applications_gdspa.FieldCategoryDescription, exam_applications_gdspa.FieldDisabilityTypeID, exam_applications_gdspa.FieldDisabilityTypeCode, exam_applications_gdspa.FieldDisabilityTypeDescription, exam_applications_gdspa.FieldDCCS, exam_applications_gdspa.FieldEntryPostCode, exam_applications_gdspa.FieldEntryPostDescription, exam_applications_gdspa.FieldPresentPostCode, exam_applications_gdspa.FieldPresentPostDescription, exam_applications_gdspa.FieldFeederPostCode, exam_applications_gdspa.FieldFeederPostDescription, exam_applications_gdspa.FieldFeederPostJoiningDate, exam_applications_gdspa.FieldPresentDesignation, exam_applications_gdspa.FieldEducationCode, exam_applications_gdspa.FieldEducationDescription, exam_applications_gdspa.FieldFacilityUniqueID, exam_applications_gdspa.FieldWorkingOfficeFacilityID, exam_applications_gdspa.FieldWorkingOfficeName, exam_applications_gdspa.FieldWorkingOfficeCircleFacilityID, exam_applications_gdspa.FieldWorkingOfficeCircleName, exam_applications_gdspa.FieldWorkingOfficeRegionFacilityID, exam_applications_gdspa.FieldWorkingOfficeRegionName, exam_applications_gdspa.FieldWorkingOfficeDivisionFacilityID, exam_applications_gdspa.FieldWorkingOfficeDivisionName, exam_applications_gdspa.FieldReportingOfficeFacilityID, exam_applications_gdspa.FieldReportingOfficeName, exam_applications_gdspa.FieldLienControllingOfficeID, exam_applications_gdspa.FieldLienControllingOfficeName, exam_applications_gdspa.FieldInDeputation, exam_applications_gdspa.FieldDeputationType, exam_applications_gdspa.FieldDeputationOfficeUniqueId, exam_applications_gdspa.FieldDeputationOfficeFacilityID, exam_applications_gdspa.FieldDeputationOfficeName, exam_applications_gdspa.FieldDeputationControllingOfficeID, exam_applications_gdspa.FieldDeputationControllingOfficeName, exam_applications_gdspa.FieldControllingOfficeFacilityID, exam_applications_gdspa.FieldControllingOfficeName, exam_applications_gdspa.FieldSubdivisionOfficeFacilityID, exam_applications_gdspa.FieldSubdivisionOfficeName, exam_applications_gdspa.FieldNodalOfficeFacilityID, exam_applications_gdspa.FieldNodalOfficeName, exam_applications_gdspa.FieldCenterFacilityId, exam_applications_gdspa.FieldCentrePreference, exam_applications_gdspa.FieldSignature, exam_applications_gdspa.FieldPhoto, exam_applications_gdspa.FieldSignaturePath, exam_applications_gdspa.FieldPhotoPath, exam_applications_gdspa.FieldTempHallTicket, exam_applications_gdspa.FieldCandidateRemarks, exam_applications_gdspa.FieldVAGeneralRemarks, exam_applications_gdspa.FieldCAGeneralRemarks, exam_applications_gdspa.FieldNAGeneralRemarks, exam_applications_gdspa.FieldApplicationStatus, exam_applications_gdspa.FieldStatus, exam_applications_gdspa.FieldRecommendedStatus, exam_applications_gdspa.FieldDesignationID, exam_applications_gdspa.FieldVAUserName, exam_applications_gdspa.FieldVAEmployeeID, exam_applications_gdspa.FieldVAEmployeeDesignation, exam_applications_gdspa.FieldVARemarks, exam_applications_gdspa.FieldCAUserName, exam_applications_gdspa.FieldCAEmployeeID, exam_applications_gdspa.FieldCAEmployeeDesignation, exam_applications_gdspa.FieldCARemarks, exam_applications_gdspa.FieldNAUserName, exam_applications_gdspa.FieldNAEmployeeID, exam_applications_gdspa.FieldNAEmployeeDesignation, exam_applications_gdspa.FieldNARemarks, exam_applications_gdspa.FieldAppliactionRemarks, exam_applications_gdspa.FieldCAPreviousRemarks, exam_applications_gdspa.FieldHallTicketNumber, exam_applications_gdspa.FieldTemporaryHallTicket, exam_applications_gdspa.FieldOptionUsed, exam_applications_gdspa.FieldRemarks, exam_applications_gdspa.FieldCadre, exam_applications_gdspa.FieldEmployeePost, exam_applications_gdspa.FieldDOJInEligiblePost, exam_applications_gdspa.FieldDCInPresentCadre, exam_applications_gdspa.FieldReportingOfficeID, exam_applications_gdspa.FieldClaimingQualifyingService, exam_applications_gdspa.FieldDeputationOfficePincode, exam_applications_gdspa.FieldUpdatedBy, exam_applications_gdspa.FieldHallName, exam_applications_gdspa.FieldFacilityName:
			values[i] = new(sql.NullString)
		case exam_applications_gdspa.FieldApplnSubmittedDate, exam_applications_gdspa.FieldVADate, exam_applications_gdspa.FieldCADate, exam_applications_gdspa.FieldNADate, exam_applications_gdspa.FieldHallTicketGeneratedDate, exam_applications_gdspa.FieldUpdatedAt, exam_applications_gdspa.FieldApplicationWdlDate:
			values[i] = new(sql.NullTime)
		case exam_applications_gdspa.ForeignKeys[0]: // user_master_users_gdspa_ref
			values[i] = new(sql.NullInt64)
		default:
...
func (eag *Exam_Applications_GDSPA) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case exam_applications_gdspa.FieldWorkingOfficeCircleName:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field WorkingOfficeCircleName", values[i])
			} else if value.Valid {
				eag.WorkingOfficeCircleName = value.String
			}
		case exam_applications_gdspa.FieldWorkingOfficeRegionFacilityID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_gdspa.FieldWorkingOfficeRegionName:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field WorkingOfficeRegionName", values[i])
			} else if value.Valid {
				eag.WorkingOfficeRegionName = value.String
			}
		case exam_applications_gdspa.FieldWorkingOfficeDivisionFacilityID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_gdspa.FieldWorkingOfficeDivisionName:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_gdspa.FieldReportingOfficeFacilityID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_gdspa.FieldDeputationOfficeName:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field DeputationOfficeName", values[i])
			} else if value.Valid {
				eag.DeputationOfficeName = value.String
			}
		case exam_applications_gdspa.FieldDeputationControllingOfficeID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_gdspa.FieldDeputationControllingOfficeName:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_gdspa.FieldControllingOfficeFacilityID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_gdspa.FieldControllingOfficeName:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field ControllingOfficeName", values[i])
			} else if value.Valid {
				eag.ControllingOfficeName = value.String
			}
		case exam_applications_gdspa.FieldSubdivisionOfficeFacilityID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case exam_applications_gdspa.FieldCAPreviousRemarks:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field CAPreviousRemarks", values[i])
			} else if value.Valid {
				eag.CAPreviousRemarks = value.String
			}
		case exam_applications_gdspa.FieldGenerateHallTicketFlag:
		...
		case exam_applications_gdspa.FieldServiceLength:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case exam_applications_gdspa.FieldNonQualifyingService:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case exam_applications_gdspa.FieldUnitPreferences:
			if value, ok := values[i].(*[]byte); !ok {
...
// Value returns the ent.Value that was dynamically selected and assigned to the Exam_Applications_GDSPA.
// This includes values selected through modifiers, order, etc.
func (eag *Exam_Applications_GDSPA) Value(name string) (ent.Value, error) {
	return eag.selectValues.Get(name)
}

// QueryUsersGDSPARef queries the "UsersGDSPARef" edge of the Exam_Applications_GDSPA entity.
func (eag *Exam_Applications_GDSPA) QueryUsersGDSPARef() *UserMasterQuery {
	return NewExamApplicationsGDSPAClient(eag.config).QueryUsersGDSPARef(eag)
}

// QueryExamcitycenter queries the "examcitycenter" edge of the Exam_Applications_GDSPA entity.
func (eag *Exam_Applications_GDSPA) QueryExamcitycenter() *ExamCityCenterQuery {
	return NewExamApplicationsGDSPAClient(eag.config).QueryExamcitycenter(eag)
}

// QueryGDSPAExamCentres queries the "GDSPAExamCentres" edge of the Exam_Applications_GDSPA entity.
func (eag *Exam_Applications_GDSPA) QueryGDSPAExamCentres() *CenterQuery {
	return NewExamApplicationsGDSPAClient(eag.config).QueryGDSPAExamCentres(eag)
}

// QueryRoleusers queries the "roleusers" edge of the Exam_Applications_GDSPA entity.
func (eag *Exam_Applications_GDSPA) QueryRoleusers() *RoleMasterQuery {
	return NewExamApplicationsGDSPAClient(eag.config).QueryRoleusers(eag)
}

// QueryCadrePrefRef queries the "CadrePref_Ref" edge of the Exam_Applications_GDSPA entity.
func (eag *Exam_Applications_GDSPA) QueryCadrePrefRef() *CadreChoicePAQuery {
	return NewExamApplicationsGDSPAClient(eag.config).QueryCadrePrefRef(eag)
}

// QueryCirclePrefRefGDSPA queries the "CirclePrefRefGDSPA" edge of the Exam_Applications_GDSPA entity.
func (eag *Exam_Applications_GDSPA) QueryCirclePrefRefGDSPA() *DivisionChoicePAQuery {
	return NewExamApplicationsGDSPAClient(eag.config).QueryCirclePrefRefGDSPA(eag)
}

// QueryGDSPAApplicationsRef queries the "GDSPAApplicationsRef" edge of the Exam_Applications_GDSPA entity.
func (eag *Exam_Applications_GDSPA) QueryGDSPAApplicationsRef() *RecommendationsGDSPAApplicationsQuery {
	return NewExamApplicationsGDSPAClient(eag.config).QueryGDSPAApplicationsRef(eag)
}

// QueryExams queries the "Exams" edge of the Exam_Applications_GDSPA entity.
func (eag *Exam_Applications_GDSPA) QueryExams() *ExamQuery {
	return NewExamApplicationsGDSPAClient(eag.config).QueryExams(eag)
}

// QueryCircleRefsGDSPA queries the "CircleRefsGDSPA" edge of the Exam_Applications_GDSPA entity.
func (eag *Exam_Applications_GDSPA) QueryCircleRefsGDSPA() *CircleSummaryForNOQuery {
	return NewExamApplicationsGDSPAClient(eag.config).QueryCircleRefsGDSPA(eag)
}

// QueryLogData queries the "LogData" edge of the Exam_Applications_GDSPA entity.
func (eag *Exam_Applications_GDSPA) QueryLogData() *LogsQuery {
	return NewExamApplicationsGDSPAClient(eag.config).QueryLogData(eag)
}

// Update returns a builder for updating this Exam_Applications_GDSPA.
// Note that you need to call Exam_Applications_GDSPA.Unwrap() before calling this method if this Exam_Applications_GDSPA
// was returned from a transaction, and the transaction was committed or rolled back.
func (eag *Exam_Applications_GDSPA) Update() *ExamApplicationsGDSPAUpdateOne {
	return NewExamApplicationsGDSPAClient(eag.config).UpdateOne(eag)
}

// Unwrap unwraps the Exam_Applications_GDSPA entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (eag *Exam_Applications_GDSPA) Unwrap() *Exam_Applications_GDSPA {
	_tx, ok := eag.config.driver.(*txDriver)
	if !ok {
		panic("ent: Exam_Applications_GDSPA is not a transactional entity")
	}
...
func (eag *Exam_Applications_GDSPA) String() string {
	var builder strings.Builder
	builder.WriteString("Exam_Applications_GDSPA(")
...
// Exam_Applications_GDSPAs is a parsable slice of Exam_Applications_GDSPA.
type Exam_Applications_GDSPAs []*Exam_Applications_GDSPA
