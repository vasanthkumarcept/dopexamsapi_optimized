...
const (
	// Label holds the string label denoting the exam_applications_pmpa type in the database.
	Label = "exam_applications_pmpa"
	...
	// FieldLatitudeLongitude holds the string denoting the latitudelongitude field in the database.
	FieldLatitudeLongitude = "latitude_longitude"
	...
	// EdgeCirclePrefRefPMPA holds the string denoting the circleprefrefpmpa edge name in mutations.
	EdgeCirclePrefRefPMPA = "CirclePrefRefPMPA"
	// EdgePMPAApplicationsRef holds the string denoting the pmpaapplicationsref edge name in mutations.
	EdgePMPAApplicationsRef = "PMPAApplicationsRef"
	// EdgeExams holds the string denoting the exams edge name in mutations.
	EdgeExams = "Exams"
	// EdgePMPAExamCentres holds the string denoting the pmpaexamcentres edge name in mutations.
	EdgePMPAExamCentres = "PMPAExamCentres"
	// EdgeCircleRefsPMPA holds the string denoting the circlerefspmpa edge name in mutations.
	EdgeCircleRefsPMPA = "CircleRefsPMPA"
	...
	// Cadre_Choice_PMPAFieldID holds the string denoting the ID field of the Cadre_Choice_PMPA.
	Cadre_Choice_PMPAFieldID = "CadrePrefId"
	// Division_Choice_PMPAFieldID holds the string denoting the ID field of the Division_Choice_PMPA.
	Division_Choice_PMPAFieldID = "CadrePrefId"
	// RecommendationsPMPAApplicationsFieldID holds the string denoting the ID field of the RecommendationsPMPAApplications.
	RecommendationsPMPAApplicationsFieldID = "RecommendationId"
	...
	ExamcitycenterTable = "Exam_Applications_PMPA"
	...
	CadrePrefRefTable = "Cadre_Choice_PMPA"
	// CadrePrefRefInverseTable is the table name for the Cadre_Choice_PMPA entity.
	// It exists in this package in order to avoid circular dependency with the "cadre_choice_pmpa" package.
	CadrePrefRefInverseTable = "Cadre_Choice_PMPA"
	// CadrePrefRefColumn is the table column denoting the CadrePref_Ref relation/edge.
	CadrePrefRefColumn = "application_id"
	// CirclePrefRefPMPATable is the table that holds the CirclePrefRefPMPA relation/edge.
	CirclePrefRefPMPATable = "Division_Choice_PMPA"
	// CirclePrefRefPMPAInverseTable is the table name for the Division_Choice_PMPA entity.
	// It exists in this package in order to avoid circular dependency with the "division_choice_pmpa" package.
	CirclePrefRefPMPAInverseTable = "Division_Choice_PMPA"
	// CirclePrefRefPMPAColumn is the table column denoting the CirclePrefRefPMPA relation/edge.
	CirclePrefRefPMPAColumn = "exam_applications_pmpa_circle_pref_ref_pmpa"
	// PMPAApplicationsRefTable is the table that holds the PMPAApplicationsRef relation/edge.
	PMPAApplicationsRefTable = "RecommendationsPMPAApplications"
	// PMPAApplicationsRefInverseTable is the table name for the RecommendationsPMPAApplications entity.
	// It exists in this package in order to avoid circular dependency with the "recommendationspmpaapplications" package.
	PMPAApplicationsRefInverseTable = "RecommendationsPMPAApplications"
	// PMPAApplicationsRefColumn is the table column denoting the PMPAApplicationsRef relation/edge.
	PMPAApplicationsRefColumn = "exam_applications_pmpa_pmpa_applications_ref"
	// ExamsTable is the table that holds the Exams relation/edge.
	ExamsTable = "Exam_Applications_PMPA"
	...
	// PMPAExamCentresTable is the table that holds the PMPAExamCentres relation/edge.
	PMPAExamCentresTable = "Exam_Applications_PMPA"
	// PMPAExamCentresInverseTable is the table name for the Center entity.
	// It exists in this package in order to avoid circular dependency with the "center" package.
	PMPAExamCentresInverseTable = "Center"
	// PMPAExamCentresColumn is the table column denoting the PMPAExamCentres relation/edge.
	PMPAExamCentresColumn = "center_code"
	// CircleRefsPMPATable is the table that holds the CircleRefsPMPA relation/edge.
	CircleRefsPMPATable = "Exam_Applications_PMPA"
	// CircleRefsPMPAInverseTable is the table name for the CircleSummaryForNO entity.
	// It exists in this package in order to avoid circular dependency with the "circlesummaryforno" package.
	CircleRefsPMPAInverseTable = "CircleSummaryForNO"
	// CircleRefsPMPAColumn is the table column denoting the CircleRefsPMPA relation/edge.
	CircleRefsPMPAColumn = "circle_sid"
	...
	LogDataColumn = "exam_applications_pmpa_log_data"
)

// Columns holds all SQL columns for exam_applications_pmpa fields.
var Columns = []string{
	FieldID,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "Exam_Applications_PMPA"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"user_master_users_pmpa_ref",
}
...
// ByLatitudeLongitude orders the results by the LatitudeLongitude field.
func ByLatitudeLongitude(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldLatitudeLongitude, opts...).ToFunc()
}
...
// ByCirclePrefRefPMPACount orders the results by CirclePrefRefPMPA count.
func ByCirclePrefRefPMPACount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newCirclePrefRefPMPAStep(), opts...)
	}
}

// ByCirclePrefRefPMPA orders the results by CirclePrefRefPMPA terms.
func ByCirclePrefRefPMPA(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newCirclePrefRefPMPAStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}

// ByPMPAApplicationsRefCount orders the results by PMPAApplicationsRef count.
func ByPMPAApplicationsRefCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newPMPAApplicationsRefStep(), opts...)
	}
}

// ByPMPAApplicationsRef orders the results by PMPAApplicationsRef terms.
func ByPMPAApplicationsRef(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newPMPAApplicationsRefStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
// ByPMPAExamCentresField orders the results by PMPAExamCentres field.
func ByPMPAExamCentresField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newPMPAExamCentresStep(), sql.OrderByField(field, opts...))
	}
}

// ByCircleRefsPMPAField orders the results by CircleRefsPMPA field.
func ByCircleRefsPMPAField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newCircleRefsPMPAStep(), sql.OrderByField(field, opts...))
	}
}
...
func newUsersPMPARefStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		...
		sqlgraph.To(UsersPMPARefInverseTable, UserMasterFieldID),
...
func newCadrePrefRefStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(CadrePrefRefInverseTable, Cadre_Choice_PMPAFieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, CadrePrefRefTable, CadrePrefRefColumn),
	)
}
func newCirclePrefRefPMPAStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(CirclePrefRefPMPAInverseTable, Division_Choice_PMPAFieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, CirclePrefRefPMPATable, CirclePrefRefPMPAColumn),
	)
}
func newPMPAApplicationsRefStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(PMPAApplicationsRefInverseTable, RecommendationsPMPAApplicationsFieldID),
...
func newPMPAExamCentresStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(PMPAExamCentresInverseTable, CenterFieldID),
		sqlgraph.Edge(sqlgraph.M2O, true, PMPAExamCentresTable, PMPAExamCentresColumn),
	)
}
func newCircleRefsPMPAStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(CircleRefsPMPAInverseTable, CircleSummaryForNOFieldID),
