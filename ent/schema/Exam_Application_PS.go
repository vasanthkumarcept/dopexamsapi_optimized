...
func (Exam_Applications_PS) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Bool("PunishmentStatus").Optional().Default(false),		
		field.Bool("DisciplinaryCaseStatus").Optional().Default(false),		
...
func (Exam_Applications_PS) Indexes() []ent.Index {
	return []ent.Index{
...
func (Exam_Applications_PS) Edges() []ent.Edge {
	...
	//	edge.To("ExamAppln_PS_Ref", Exam_PS.Type),
		edge.To("CadrePrefPS_Ref", Cadre_Choice_PS.Type),
		edge.To("CirclePrefRefPS", PlaceOfPreferencePS.Type),
		edge.To("PSApplicationsRef", RecommendationsPSApplications.Type),
		//edge.From("PSExamCentres", Center.Type). Ref("ExamCentresRefPS").Unique().Field("ExamCityCenterCode"),
		edge.From("ExamsPS", Exam.Type).Ref("ExamMasterRefPS").Unique().Field("ExamCode"),
		edge.From("roleusers", RoleMaster.Type).Ref("Roles_PS_Ref").Unique().Field("RoleUserCode"),
		edge.From("examcitycenter", ExamCityCenter.Type).Ref("ExamCityCenterPSRef").Unique().Field("ExamCityCenterCode"),
		edge.From("PSExamCentres", Center.Type). Ref("ExamCentresRefPS").Unique().Field("CenterCode"),
		edge.From("CircleRefs", CircleSummaryForNO.Type).Ref("CircleRefsForHallTicketPS").Unique().Field("CircleSID"),
		edge.To("LogData", Logs.Type),
		//edge.From("ExamCenterHallPSRefs", ExamCenterHall.Type).Ref("ExamCenterHallPSRef").Unique().Field("ExamCenterHall"),
